...
namespace half_pipe_app {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductRow AddProductRow(int Id, string Наименование, string _Штрих_код, string Тип, string Цена, string Дополнительно) {
            ...
            private void InitClass() {
                ...
                this.columnId.AllowDBNull = false;
                this.columnId.Unique = true;
                this.columnНаименование.Caption = "Телефон";
                this.columnНаименование.MaxLength = 16;
                this._columnШтрих_код.Caption = "Паспорт";
                this._columnШтрих_код.MaxLength = 11;
                this.columnТип.Caption = "Дополнительно";
                this.columnТип.MaxLength = 2147483647;
                this.columnЦена.AllowDBNull = false;
                this.columnЦена.Caption = "ФИО";
                this.columnЦена.MaxLength = 350;
            }
        ...
        public partial class ProductRow : global::System.Data.DataRow {
            ...
            public string _Штрих_код {
                get {
                    try {
                        return ((string)(this[this.tableProduct._Штрих_кодColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Штрих-код\' в таблице \'Product\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableProduct._Штрих_кодColumn] = value;
                }
            }
            ...
            public string Тип {
                get {
                    try {
                        return ((string)(this[this.tableProduct.ТипColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Тип\' в таблице \'Product\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableProduct.ТипColumn] = value;
                }
            }
            ...
            public string Цена {
                get {
                    return ((string)(this[this.tableProduct.ЦенаColumn]));
                }
                set {
                    this[this.tableProduct.ЦенаColumn] = value;
                }
            }
            ...
            public string Дополнительно {
                get {
                    try {
                        return ((string)(this[this.tableProduct.ДополнительноColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Дополнительно\' в таблице \'Product\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableProduct.ДополнительноColumn] = value;
                }
            }
            ...
            public bool Is_Штрих_кодNull() {
                return this.IsNull(this.tableProduct._Штрих_кодColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void Set_Штрих_кодNull() {
                this[this.tableProduct._Штрих_кодColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsТипNull() {
                return this.IsNull(this.tableProduct.ТипColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetТипNull() {
                this[this.tableProduct.ТипColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsДополнительноNull() {
                return this.IsNull(this.tableProduct.ДополнительноColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetДополнительноNull() {
                this[this.tableProduct.ДополнительноColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace half_pipe_app.Database1DataSetTableAdapters {
...
SELECT Id, Дополнительно, Паспорт, Телефон, ФИО FROM Buyers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::half_pipe_app.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        public virtual int Fill(Database1DataSet.BuyersDataTable dataTable) {
        ...
        public virtual Database1DataSet.BuyersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.BuyersDataTable dataTable = new Database1DataSet.BuyersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.BuyersDataTable dataTable) {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Id", "Id");
            tableMapping.ColumnMappings.Add("Телефон", "Наименование");
            tableMapping.ColumnMappings.Add("Паспорт", "Штрих-код");
            tableMapping.ColumnMappings.Add("Дополнительно", "Тип");
            tableMapping.ColumnMappings.Add("ФИО", "Цена");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Buyers] WHERE (([Id] = @Original_Id) AND ((@IsNull_Паспорт = 1 AND [" +
